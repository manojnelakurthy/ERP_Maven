...
public static  WebDriver startBrowser() throws Throwable{
	if(PropertyFileUtil.getVAlueForKey("Browser").equalsIgnoreCase("chrome")){
		System.setProperty("webdriver.chrome.driver", "D:\\Selenium_Evening\\ERP_Maven\\CommonDrivers\\chromedriver.exe");
		driver=new ChromeDriver();	
	}
	else if(PropertyFileUtil.getVAlueForKey("Browser").equalsIgnoreCase("firefox"))
	{
		System.setProperty("webdriver.gecko.driver", "D:\\Selenium_Evening\\ERP_Maven\\CommonDrivers\\geckodriver.exe");
...
public static void captureData(WebDriver driver,String locatortype,String locatorvalue) throws Throwable{
	...
	FileWriter fw=new FileWriter("D:\\Selenium_Evening\\ERP_Maven\\CaptureData\\Supplier.txt");
...
{
FileReader fr=new FileReader("D:\\Selenium_Evening\\ERP_Maven\\CaptureData\\supplier.txt");
